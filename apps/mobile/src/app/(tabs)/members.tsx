  ...
  return (
    ...
    >
      <ThemedView style={styles.container}>
        <ThemedText type="subtitle" style={styles.title}>{t('members.title')}</ThemedText>
        ...
        <Pressable
          ...
          disabled={leaving}
          style={({ pressed }) => [styles.leaveBtn, { borderColor: theme.danger }, pressed && { opacity: 0.8 }, leaving && { opacity: 0.5 }]}
        >
