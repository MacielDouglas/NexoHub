...
- **Direção escolhida:** mundo bancário Itaú atual — tinta `#0c0c12` + laranja `#ec7000`, conteúdo global do shell permanece claro. Hero "saldo" com total + 5 células de extrato, busca pill, linhas por família.
